...
const vendingDropdown = [
  ...
  { label: "Solo QR (UPI)", href: "/products/solo-qr-vending-machine" },
  { label: "Solo RFID", href: "/products/solo-rfid-vending-machine" },
  { label: "Solo WiFi", href: "/products/solo-wifi-vending-machine" },
          ...
          >
            <div className="px-5 py-3 flex flex-col">
              ...
              <div className="pt-3 pb-1 grid grid-cols-3 gap-2">
                ...
                <a href={`https://wa.me/918122378860?text=${encodeURIComponent("Hi! I'm interested in Lyra Enterprisess' vending machines / incinerators. Please share details.")}`} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 py-3 rounded-xl bg-green-50 border border-green-100 active:bg-green-100">
                ...
                <a href={`mailto:sales@lyraenterprise.co.in?subject=Product Inquiry - Lyra Enterprises&body=${EMAIL_MESSAGE}`} className="flex flex-col items-center gap-1 py-3 rounded-xl bg-indigo-50 border border-indigo-100 active:bg-indigo-100">
