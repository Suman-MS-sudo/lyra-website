        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="#home" className="flex items-center gap-3 group">
            <div className="relative w-10 h-10">
              <div className="absolute inset-0 bg-purple-gradient rounded-xl opacity-90 group-hover:opacity-100 transition-opacity" />
          ...
          <nav className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="relative text-sm font-medium text-gray-600 hover:text-primary-600 transition-colors duration-200 group"
              >
                {link.label}
            ...
            <div className="px-6 py-4 flex flex-col gap-4">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="text-gray-700 font-medium hover:text-primary-600 transition-colors py-1"
                >
                  {link.label}
                </Link>
              ))}
