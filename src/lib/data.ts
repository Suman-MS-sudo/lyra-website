...
export type Product = {
  ...
  /** Google Merchant Center g:description — up to 5000 characters, keyword-rich, no HTML. Falls back to `description` if unset. */
...
export const products: Product[] = [
  // ─── VENDING MACHINES ───────────────────────────────────────
  {
    ...
    merchantDescription:
      "Lyra Push Button Sanitary Napkin Vending Machine (Model Lyra/SNVM/PB) is a fully offline, one-touch push-button dispenser built for schools, colleges, hostels, government institutions, small offices and public restrooms across India. Unlike bare mechanical coin boxes sold at this price point, the Push Button runs on an onboard microcontroller with a battery-backed real-time clock that timestamps every single dispense, so administrators always have an accurate usage record even through power outages — with no internet connection, SIM card or data plan required at any point.\n\nTo check stock and usage, staff simply press the machine's own WiFi button to open a private on-device hotspot, connect any smartphone to it, and download a spreadsheet-ready CSV report in seconds. There is no app to install, no login screen and no recurring data cost — the machine stores up to 90 days of usage history on-device, making it easy to produce audit trails, budget refill schedules or justify procurement renewals without ever touching a cloud dashboard.\n\nBuilt-in engineering protects the machine itself: the motor automatically cuts out the moment stock runs out, preventing the dry-cycle burnout that damages unprotected vending mechanisms over months of use, extending the working life of the unit well beyond typical budget machines. An anti-tampering lockout also detects repeated or forceful jamming of the push button, temporarily disables vending and logs the incident, discouraging misuse in unsupervised public washrooms.\n\nThe cabinet is a sheet-metal, epoxy-coated enclosure with a transparent front view panel so facility staff can see remaining stock at a glance without opening the unit, and vertical top-loading makes refilling fast during routine maintenance rounds. At 700 x 160 x 160 mm and 10 kg, it wall-mounts easily inside a standard washroom cubicle without requiring structural changes, and runs on standard 230V AC mains power — no batteries to replace for the dispensing mechanism itself.\n\nThe Push Button holds 25 sanitary napkins per fill (napkin count varies slightly with pad thickness) and dispenses one napkin per selection with a single press — no coins to manage, no correct change required from users, and nothing for facility staff to reconcile at the end of the day beyond a simple stock refill. This makes it especially well suited to institutions that want reliable, trackable dispensing without the overhead of coin collection, UPI payment gateways or ongoing connectivity costs.\n\nWhy institutions choose the Lyra Push Button over comparable machines: most sanitary napkin vending machines under fifteen thousand rupees are purely mechanical with zero usage tracking, so schools and hostels have no visibility into consumption patterns or refill timing. The Push Button brings genuine smart-machine intelligence — live stock tracking, tamper detection and exportable usage analytics — to that same budget tier, with zero ongoing subscription cost for the lifetime of the machine. Where competing “smart” vending machines typically require an active SIM card and monthly data recharge just to unlock basic reporting, the Lyra Push Button's offline WiFi-hotspot reporting means the feature works identically on day one and after five years, with nothing to pay beyond the one-time purchase price.\n\nThis model is trusted by 50-plus schools, colleges and government institutions across Tamil Nadu and Kerala, and is manufactured in-house at Lyra Enterprises' Chennai facility, giving buyers direct access to the manufacturer for installation guidance, spares and after-sales support rather than routing through a reseller. Every unit ships with a 1-year manufacturer warranty covering parts and workmanship defects, and Lyra provides free installation guidance plus remote support pan-India, with on-site installation available across Tamil Nadu, Kerala, Karnataka, Andhra Pradesh and Telangana.\n\nTypical buyers include government and private schools implementing menstrual hygiene programmes, colleges and hostels equipping dormitory washrooms, rural health centres, small and mid-size corporate offices, and public restroom operators who want dependable dispensing without connectivity dependence. Bulk and multi-unit institutional orders qualify for volume pricing — contact Lyra Enterprises directly for a bulk quote, CSR/welfare-scheme proposal, or a site visit to confirm installation requirements before ordering. The Lyra Push Button sanitary napkin vending machine ships pan-India from Chennai, with typical transit time of three to seven business days depending on destination.",
    longDescription:
  ...
  },
  {
    ...
    badge: "RFID",
    tagline: "IoT RFID access control — prepaid & postpaid billing, wired network, works offline",
    description:
      "IoT RFID card/tag operated sanitary napkin vending machine. Prepaid & postpaid billing, per-card monthly limits, wired network with offline resilience, live cloud dashboard and full audit trail. For corporate campuses and hostels.",
    merchantDescription:
      "Lyra Solo RFID Sanitary Napkin Vending Machine (Model Lyra/SNVM/RFID) is a full IoT, tap-to-dispense sanitary napkin vending machine built for corporate campuses, hostels and other controlled-access institutions across India that need identity-linked dispensing at scale. A single tap of an RFID card or tag dispenses one napkin instantly — no coins, no QR scanning and no app needed at the point of use — with a live on-screen status display that shows ready, dispensing, out of stock, or a clear message for every outcome including declined card, no balance, monthly limit reached, out of stock, or payment failed.\n\nIt supports both prepaid, balance-based cards and postpaid cards billed later, with per-card monthly usage limits that administrators configure remotely from the cloud dashboard. Cards can be activated or deactivated instantly at any time, which is useful when staff leave an organisation or a lost card needs to be blocked immediately. A built-in cross-organization protection layer politely rejects a card issued by a different organisation at the machine itself, without ever revealing where the card actually belongs, keeping shared or multi-tenant campuses secure.\n\nThe machine connects over a wired network for stable, uninterrupted operation, which is ideal for institutions with strict IT security policies or unreliable WiFi coverage, and it reconnects automatically the moment a dropped connection is restored, with no manual intervention needed on site. Every communication between the machine and the cloud is encrypted and verified, and no sensitive card or payment data is ever exposed locally or transmitted unencrypted.\n\nCritically, the Solo RFID keeps dispensing even when the network goes down. It maintains a secure local copy of authorized cards on-device, safely queues every offline transaction, and automatically syncs everything to the cloud the moment connectivity returns — preserving accurate timestamps for every transaction even across a power interruption during the outage. It is engineered to scale to large card rosters of thousands of employees or residents, not just a handful of users, which makes it suitable for large corporate campuses, hostel complexes and multi-building institutions.\n\nAdministrators get a live cloud dashboard showing stock levels, machine status and sales or usage figures from any browser, automatic low-stock alerts so refills never get missed, and per-card usage reports with a full audit trail showing exactly who dispensed what and when — useful for departmental cost allocation, hostel block billing, or identifying misuse. The machine checks in with the cloud automatically, so administrators always know its live online or offline status without having to physically inspect it.\n\nFirmware updates are delivered remotely over the network, with every update verified for integrity before installing and automatic rollback protection that reverts the machine to its last working version if an update ever fails — so a facility never loses vending capability waiting for a technician visit. A physical refill button lets on-site staff top up stock during routine rounds, with the change instantly reflected on the dashboard. Built-in fault recovery detects and resolves internal hangs on its own, the machine recovers gracefully from power fluctuations, and continuous self-monitoring of critical components catches issues before they ever affect a user.\n\nHoused in a compact 700 x 160 x 160 mm sheet-metal, epoxy-coated cabinet with a transparent view panel and vertical loading, it wall-mounts easily inside a standard washroom cubicle and weighs 10 kg, holding 25 sanitary napkins per fill. The Solo RFID is manufactured in-house at Lyra Enterprises' Chennai facility, ships with a 1-year manufacturer warranty, and includes free installation guidance and remote support pan-India, with on-site installation available across Tamil Nadu, Kerala, Karnataka, Andhra Pradesh and Telangana. Contact Lyra Enterprises for bulk institutional pricing or to plan a multi-machine, multi-building rollout.",
    longDescription:
      "The Lyra Solo RFID is a full IoT sanitary napkin vending machine built for corporate campuses, hostels and other controlled-access institutions that need identity-linked dispensing at scale. A single tap of an RFID card or tag dispenses instantly — no coins, no QR scanning, no app needed at the point of use — with a live on-screen status display showing ready, dispensing, out of stock or a clear error message for every outcome (declined card, no balance, monthly limit reached, out of stock, payment failed).\n\nIt supports both prepaid, balance-based cards and postpaid cards billed later, with per-card monthly usage limits that admins configure remotely. Cards can be activated or deactivated instantly from the cloud dashboard, and a cross-organization protection layer politely rejects a card issued by another organization without ever revealing where it actually belongs.\n\nThe machine connects over a wired network for stable, uninterrupted operation — ideal for institutions with strict IT policies or unreliable WiFi — and reconnects automatically if the network drops, with no manual intervention needed. Every communication with the cloud is encrypted and verified, and no sensitive card or payment data is ever exposed locally or transmitted unencrypted.\n\nIt keeps dispensing even when the network is down: the machine maintains a secure local copy of authorized cards, safely queues every offline transaction and automatically syncs to the cloud once the connection returns, preserving accurate timestamps for every transaction even across a power interruption during the outage. It's engineered to scale to large card rosters — thousands of employees or residents, not just a handful of users.\n\nAdmins get a live cloud dashboard showing stock levels, machine status and sales/usage from any browser, automatic low-stock alerts, and per-card usage reports with a full audit trail — exactly who dispensed what and when. The machine checks in with the cloud automatically so admins always know its online/offline status. Firmware updates over the network are verified for integrity before installing, with automatic rollback protection if an update ever fails, and a physical refill button lets on-site staff top up stock with the change instantly reflected on the dashboard. Built-in fault recovery detects and resolves internal hangs on its own, recovers gracefully from power fluctuations, and continuously self-monitors every critical component to catch issues before they affect a user.",
    features: [
      "Tap-to-dispense RFID card/tag — no coins, QR scanning or app needed",
      "Instant dispensing the moment a valid card is tapped",
      "Live on-screen status display — ready, dispensing, out of stock, error messages",
      "Clear prompts for declined card, no balance, limit reached, out of stock, payment failed",
      "Supports both prepaid (balance) and postpaid (billed later) cards",
      "Per-card monthly usage limits, admin-configurable",
      "Remote card activation / deactivation at any time",
      "Cross-organization protection — foreign cards politely rejected",
      "Wired network connection for stable operation, ideal for strict IT policies",
      "Automatic reconnection if the network drops — no manual intervention",
      "Encrypted, verified cloud communication",
      "Keeps dispensing offline — secure local copy of authorized cards",
      "Offline transactions safely queued, auto-synced to cloud on reconnect",
      "Accurate timestamps preserved across power interruptions",
      "Scales to large card rosters — thousands of users",
      "Live cloud dashboard — stock, machine status, sales/usage from any browser",
      "Automatic low-stock alerts",
      "Per-card usage reports and full audit trail",
      "Automatic online/offline status check-in",
      "Remote firmware updates, integrity-verified before install",
      "Automatic rollback protection if an update fails",
      "Physical refill button — instantly reflected on dashboard",
      "Automatic fault recovery — self-resolves hangs and glitches",
      "Graceful recovery from power fluctuations",
      "Continuous self-monitoring of critical components",
      "Server-side verification before every dispense — no sensitive data exposed locally",
      "25 napkins capacity",
      "Transparent view panel",
      "Wall-mountable design",
    ],
    specs: [
      ...
      { label: "Access", value: "RFID Card / Tag — tap to dispense" },
      { label: "Billing", value: "Prepaid (balance) & postpaid (billed later)" },
      { label: "Usage Limits", value: "Per-card monthly limits, admin-configurable" },
      { label: "Display", value: "Live status screen — ready, dispensing, errors" },
      { label: "Connectivity", value: "Wired network, auto-reconnect on drop" },
      { label: "Offline Mode", value: "Local card cache, dispenses & queues offline, auto-syncs on reconnect" },
      { label: "Data", value: "Per-card usage logs & full audit trail" },
      { label: "Cloud", value: "Centralised dashboard — stock, sales, status" },
      { label: "Alerts", value: "Automatic low-stock alerts" },
      { label: "Firmware", value: "Remote updates, integrity-verified with auto-rollback" },
      { label: "Reliability", value: "Auto fault recovery, power-fluctuation resilient" },
      { label: "Security", value: "Server-side verification, encrypted cloud comms" },
      { label: "No. of Selection", value: "One" },
      { label: "Weight", value: "10 kg" },
      { label: "Housing", value: "Sheet metal cabinet, epoxy coated" },
      { label: "Loading", value: "Vertical, physical refill button" },
      { label: "Mounting", value: "Wall mount" },
    ...
    useCases: [
      ...
      "Institutions with RFID access-control systems",
      "Multi-tenant campuses issuing cards across departments/organizations",
    ],
  ...
  },
  {
    ...
    longDescription:
      "The Lyra Solo WiFi is India's most advanced IoT-enabled sanitary napkin vending machine — combining UPI QR code payments, ₹5 coin backup, 2.4GHz WiFi connectivity and a touch display in one compact unit. Every dispense is verified server-side before the pad is released, blocking spoofed or fake payment attempts, and payment confirmation is pushed to the machine in real time with an automatic fallback check so a transaction is never missed even if the instant push fails. If the WiFi drops, the machine keeps accepting and queuing transactions offline — nothing is lost, and queued sales sync automatically the moment connectivity is restored. Facility managers get a live cloud dashboard showing stock levels, sales and machine status from any browser, automatic low-stock alerts, and usage analytics/reporting. Firmware updates are delivered over the air with automatic rollback if an update ever fails, so there's no technician visit needed, and the machine self-resets automatically if it ever hangs. All machine-to-cloud communication is encrypted. This is the #1 choice for technology-forward hospitals, IT parks, premium malls and smart campuses across India.",
    features: [
      "UPI QR code payment (GPay, PhonePe, Paytm, BHIM — any NPCI-standard UPI app)",
      "₹5 coin acceptor as backup payment method",
      "Instant dispense on verified payment — no manual approval step",
      "Server-side payment verification blocks spoofed/fake payments",
      "2.4GHz WiFi — no SIM card needed",
      "Real-time payment push with automatic fallback check",
      "Offline resilience — queues transactions during WiFi outage, auto-syncs on reconnect",
      "Live cloud dashboard — stock, sales & machine status from any browser",
      "Automatic low-stock alerts",
      "Usage analytics and reporting",
      "Remote OTA firmware updates with automatic rollback",
      "Automatic fault recovery / self-reset — no manual reboot",
      "Encrypted machine-to-cloud communication",
      "Touch display",
      "25 napkins capacity",
    ],
    specs: [
      { label: "Dimensions", value: "700 × 160 × 160 mm" },
      { label: "Capacity", value: "25 napkins (varies with thickness)" },
      { label: "Payment", value: "UPI QR scanner + ₹5 coin acceptor (backup)" },
      { label: "Payment Verification", value: "Server-side, before every dispense" },
      { label: "Connectivity", value: "2.4GHz WiFi — no SIM card needed" },
      { label: "Offline Mode", value: "Queues transactions, auto-syncs on reconnect" },
      { label: "Display", value: "Touch display" },
      { label: "Data", value: "Live dashboard, usage analytics & reports" },
      { label: "Cloud", value: "Centralised dashboard — stock, sales, status" },
      { label: "Alerts", value: "Automatic low-stock alerts" },
      { label: "Firmware", value: "Remote OTA updates with auto-rollback" },
      { label: "Reliability", value: "Auto fault recovery / self-reset" },
      { label: "Security", value: "Encrypted machine-cloud communication" },
      { label: "No. of Selection", value: "One" },
      { label: "Weight", value: "10 kg" },
      { label: "Housing", value: "Sheet metal cabinet, epoxy coated" },
      { label: "Mounting", value: "Wall mount" },
  ...
  },
  {
    ...
    longDescription:
      "The Lyra Solo Ethernet sanitary napkin vending machine carries every feature of the Solo WiFi — UPI QR + ₹5 coin backup payment with server-side verification, instant dispense, live cloud dashboard, low-stock alerts, usage analytics, OTA firmware updates with auto-rollback and automatic fault recovery — but connects over a wired LAN instead of WiFi. It's built for hospitals, government buildings and large institutions where wireless signal is unreliable or restricted by IT policy, delivering a stable, low-latency connection well suited to environments with strict network segmentation. The same encrypted, verified communication channel as the WiFi model runs over the wire — nothing is ever sent in the open — and the machine plugs straight into existing network infrastructure with no WiFi router or SIM card dependency at all.",
    features: [
      "UPI QR code payment (GPay, PhonePe, Paytm, BHIM — any NPCI-standard UPI app)",
      "₹5 coin acceptor as backup payment method",
      "Instant dispense on verified payment — no manual approval step",
      "Server-side payment verification blocks spoofed/fake payments",
      "Wired LAN (Ethernet) connectivity — no WiFi router or SIM card",
      "Stable, low-latency connection for strict network-segmented environments",
      "Real-time payment push with automatic fallback check",
      "Offline resilience — queues transactions during connection loss, auto-syncs on reconnect",
      "Live cloud dashboard — stock, sales & machine status from any browser",
      "Automatic low-stock alerts",
      "Usage analytics and reporting",
      "Remote OTA firmware updates with automatic rollback",
      "Automatic fault recovery / self-reset — no manual reboot",
      "Encrypted machine-to-cloud communication over LAN",
      "Touch display",
      "25 napkins capacity",
    ],
    specs: [
      ...
      { label: "Payment", value: "UPI QR scanner + ₹5 coin acceptor (backup)" },
      { label: "Payment Verification", value: "Server-side, before every dispense" },
      { label: "Connectivity", value: "Wired Ethernet (LAN) — no WiFi/SIM needed" },
      { label: "Offline Mode", value: "Queues transactions, auto-syncs on reconnect" },
      { label: "Display", value: "Touch display" },
      { label: "Data", value: "Live dashboard, usage analytics & reports" },
      { label: "Cloud", value: "Centralised dashboard — stock, sales, status" },
...
export const blogPosts = [
  {
    ...
    category: "Education",
    metaTitle:
      "Why Every School in India Needs a Napkin Vending Machine",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "Napkin Incinerator vs Bio Bin — Which Is Better for India?",
    metaDescription:
  ...
  },
  {
    ...
    category: "Buying Guide",
    metaTitle:
      "Manual vs Automatic Napkin Vending Machine — India Guide 2026",
    metaDescription:
  ...
  },
  {
    ...
    category: "Compliance",
    metaTitle:
      "Solid Waste Management Rules 2016 — Menstrual Waste Guide",
    metaDescription:
