...
export const products: Product[] = [
  ...
  {    slug: "solo-manual-vending-machine",
    ...
    description:
      "Manual free-vend sanitary napkin vending machine for sponsored facilities. Ideal for factories, schools and institutions providing napkins free of charge.",
    longDescription:
      "The Lyra Solo Manual is designed for organisations running sponsored hygiene programmes — factories, schools, hospitals and NGO-managed facilities where napkins are provided free of cost. A simple button press delivers one napkin without any payment transaction. Built on the same robust Solo-series cabinet as our coin and RFID models, it features a tamper-proof sheet metal body, transparent view panel and wall-mount design that staff can restock in minutes.",
    features: [
      "Push-to-dispense, no payment needed",
      "25 napkins capacity",
    ...
    specs: [
      ...
      { label: "Operation", value: "Manual free-vend" },
      ...
      { label: "Model Code", value: "Lyra/SNVM/SM" },
    ],
    useCases: [
      "Factories & manufacturing units",
      "NGO & CSR hygiene programmes",
      "Government welfare institutions",
      "Schools with free napkin schemes",
      "Hospital staff washrooms",
    ],
    accent: "from-slate-400 to-slate-600",
    keywords: [
      "free vend sanitary napkin vending machine india",
      "sanitary napkin vending machine price 5000",
      "manual sanitary napkin dispenser india",
      "sponsored hygiene machine india",
      "factory napkin dispenser india",
      "CSR napkin vending machine india",
      "free sanitary napkin machine for schools",
      "push to dispense napkin machine",
      "napkin machine without coin india",
      "free napkin dispenser machine india",
    ],
    metaTitle:
      "Free-Vend Sanitary Napkin Vending Machine ₹5,000 | Lyra Enterprises India",
    metaDescription:
      "Buy Lyra Solo Manual free-vend sanitary napkin vending machine at just ₹5,000. Push-to-dispense, no coin needed, 25-napkin capacity. Best for factories, schools, CSR & NGO programmes. Chennai manufacturer. Call +91-8122378860.",
  },
  {    slug: "push-button-vending-machine",
    ...
    keywords: [
      ...
      "sanitary napkin vending machine price 11500",
    ...
    metaTitle:
      "Push Button Sanitary Napkin Vending Machine ₹11,500 | Buy India | Lyra Enterprises",
    metaDescription:
      "Buy Lyra Push Button sanitary napkin vending machine at ₹11,500. Manual dispensing, 25-napkin capacity. Best for schools, hostels & government facilities. 1-year warranty. Chennai manufacturer. Call +91-8122378860.",
  },
  {
    ...
    keywords: [
      ...
      "sanitary napkin vending machine price 12500",
    ...
    metaTitle:
      "Coin Operated Sanitary Napkin Vending Machine ₹12,500 | ₹5 Coin | Lyra Enterprises",
    metaDescription:
      "Buy Lyra Solo Coin sanitary napkin vending machine at ₹12,500. ₹5 coin acceptor, 25-napkin capacity, tested 100,000+ cycles. Best for malls, railway stations, offices & hospitals. Chennai manufacturer. Call +91-8122378860.",
  },
  {    slug: "solo-rfid-vending-machine",
    name: "Solo RFID",
    fullName: "Solo RFID Contactless Sanitary Napkin Vending Machine",
    code: "Lyra/SNVM/RF",
    category: "vending-machine",
    price: 12500,
    discountedPrice: 12500,
    badge: "Contactless",
    tagline: "Tap your RFID card — zero cash, zero hassle",
    description:
      "RFID card-operated sanitary napkin vending machine. Replaces coins with a contactless smart card tap. Ideal for corporates, factories and campuses.",
    longDescription:
      "The Lyra Solo RFID sanitary napkin vending machine is built for controlled-access environments where the organisation pre-issues RFID cards to employees or residents. Users simply tap their card to dispense one napkin, eliminating the need for coins or smartphones. Compatible with standard ISO 14443 / 15693 RFID cards, it integrates easily with existing access control infrastructure. No internet connectivity required — making it reliable even in remote locations.",
    features: [
      "RFID / smart card payment",
      "25 napkins capacity",
      "ISO 14443 & 15693 compatible",
      "Transparent view panel",
      "Tamper-proof body",
      "Wall-mountable design",
    ],
    specs: [
      { label: "Dimensions", value: "700 × 160 × 160 mm" },
      { label: "Capacity", value: "25 napkins" },
      { label: "Payment", value: "RFID / smart card" },
      { label: "Card Standard", value: "ISO 14443 / 15693" },
      { label: "Weight", value: "10 kg" },
      { label: "Material", value: "Sheet metal, epoxy coated" },
      { label: "Loading", value: "Vertical" },
      { label: "Mounting", value: "Wall mount" },
    ...
    useCases: [
      ...
      "Factories & manufacturing units",
      "University hostels & campuses",
      "Defence & PSU facilities",
      "Hospitals with employee cards",
    ],
    accent: "from-teal-400 to-cyan-600",
    keywords: [
      "rfid sanitary napkin vending machine india",
      "contactless napkin vending machine india",
      "smart card napkin dispenser india",
      "rfid napkin machine for offices india",
      "corporate sanitary napkin vending machine",
      "iso 14443 napkin vending machine",
      "access card napkin dispenser india",
      "rfid napkin machine factory india",
      "sanitary napkin vending machine price 12500",
      "cashless napkin dispenser india",
    ],
    metaTitle:
      "RFID Contactless Sanitary Napkin Vending Machine ₹12,500 | Lyra Enterprises India",
    metaDescription:
      "Buy Lyra Solo RFID sanitary napkin vending machine at ₹12,500. Contactless RFID card tap, ISO 14443/15693, 25-napkin capacity. Best for offices, factories & campuses. Chennai manufacturer. Call +91-8122378860.",
  },
  ...
  // ─── INCINERATORS ────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      "sanitary napkin incinerator price 13500",
      "swachh bharat napkin incinerator india",
      "GeM napkin incinerator india",
      "napkin incinerator for clinics india",
    ],
    metaTitle:
      "Sanitary Napkin Incinerator ₹13,500 | Compact Wall Mount | Lyra Micro India",
    metaDescription:
      "Buy Lyra Micro sanitary napkin incinerator at ₹13,500. 1–5 napkins/cycle, 100 napkins/day, digital temperature display, CPCB-compliant. Best for schools, clinics & small offices. Chennai manufacturer. Call +91-8122378860.",
  },
  {
    ...
    keywords: [
      ...
      "napkin incinerator price 18500",
    ...
    metaTitle:
      "Sanitary Napkin Incinerator ₹18,500 | 5–15 Napkins/Cycle | Lyra Mini India",
    metaDescription:
      "Buy Lyra Mini sanitary napkin incinerator at ₹18,500. 5–15 napkins/cycle, 100/day, digital temperature, SWM Rules 2016 compliant. Best for colleges, offices & hospitals. Chennai manufacturer. Call +91-8122378860.",
  },
  {
    ...
    keywords: [
      ...
      "napkin incinerator price 39500",
    ...
    metaTitle:
      "High Capacity Sanitary Napkin Incinerator ₹39,500 | Hospital Grade | Lyra Maxi India",
    metaDescription:
      "Buy Lyra Maxi high-capacity sanitary napkin incinerator at ₹39,500. 25–50 napkins/cycle, biomedical waste compliant, top-loading, remote temp logging. Best for hospitals, medical colleges & large institutions. Chennai. Call +91-8122378860.",
  },
];
...
export const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      "Manual machines cost ₹5,000. Automatic machines cost ₹11,500+. Here's exactly when to choose each — and how to avoid the wrong pick.",
    date: "2026-02-20",
    readTime: "6 min read",
    category: "Buying Guide",
    metaTitle:
