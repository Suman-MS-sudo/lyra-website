      ...
      <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
        ...
        <section className="max-w-7xl mx-auto px-5 sm:px-8 pt-8 pb-10">
          ...
          <h1 className="mt-8 font-bold text-3xl sm:text-4xl lg:text-5xl text-gray-900 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-blue-500">Across India</span>
          </h1>
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-700 rounded-full border border-blue-200 font-medium">✓ GST Invoice</span>
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-700 rounded-full border border-blue-200 font-medium">✓ Installation Support</span>
          </div>
        </section>
          ...
          return (
            <section key={region} className="max-w-7xl mx-auto px-5 sm:px-8 pb-12">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-1.5 h-10 rounded-full bg-gradient-to-b from-primary-400 to-blue-500 flex-shrink-0" />
